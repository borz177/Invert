  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-8 rounded-[40px] shadow-sm border border-slate-100 text-center relative">
        ...
        <div className="w-24 h-24 bg-indigo-600 rounded-[32px] text-white flex items-center justify-center text-4xl font-black mx-auto mb-4 shadow-xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-emerald-50 p-6 rounded-[32px] border border-emerald-100">
          ...
          <p className="text-2xl font-black text-emerald-700">{sales.length}</p>
        </div>
        <div className="bg-indigo-50 p-6 rounded-[32px] border border-indigo-100">
          <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest mb-1">Выручка</p>
